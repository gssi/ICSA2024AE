...
The following public repository contains the [replication package](#systematic-literature-review-replication-package) about the used research process and tool evaluation. Moreover, it also contains the implemented assistive modeling tool named [AssistRA] (#AssistRA).
...
The notation used is inspired by the work in~\cite{Bucaioni6504}, which is based on a refinement of the component diagram offered by UML~\cite{cheesman2000uml} and uses the components and connectors view to describe architectures. 
