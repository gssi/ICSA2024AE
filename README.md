...
The notation used is inspired by the work in[1](#1), which is based on a refinement of the component diagram offered by UML~\cite{cheesman2000uml} and uses the components and connectors view to describe architectures. 
